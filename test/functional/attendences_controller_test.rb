...
class AttendencesControllerTest < ActionController::TestCase
  ...
  test "should create attendence" do
    assert_difference('Attendence.count') do
      post :create, attendence: { event_id: @attendence.event_id, exempt: @attendence.exempt, student_id: @attendence.student_id }
    end
  ...
  test "should update attendence" do
    put :update, id: @attendence, attendence: { event_id: @attendence.event_id, exempt: @attendence.exempt, student_id: @attendence.student_id }
    assert_redirected_to attendence_path(assigns(:attendence))
  end
