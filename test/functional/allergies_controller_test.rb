...
class AllergiesControllerTest < ActionController::TestCase
  ...
  test "should create allergy" do
    assert_difference('Allergy.count') do
      post :create, allergy: { active: @allergy.active, name: @allergy.name, warning_text: @allergy.warning_text }
    end
  ...
  test "should update allergy" do
    put :update, id: @allergy, allergy: { active: @allergy.active, name: @allergy.name, warning_text: @allergy.warning_text }
    assert_redirected_to allergy_path(assigns(:allergy))
  end
