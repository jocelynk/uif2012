...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { event_id: @attendance.event_id, exempt: @attendance.exempt, student_id: @attendance.student_id }
    end
  ...
  test "should update attendance" do
    put :update, id: @attendance, attendance: { event_id: @attendance.event_id, exempt: @attendance.exempt, student_id: @attendance.student_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
