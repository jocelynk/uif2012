jQuery ->
  ...
  if document.getElementById('registration_nested_form') isnt null
    if document.getElementById('registration_nested_form').children.length <= 1
      ...
      $("#registration_nested_form").children(".fields").each ->
        self = this
      ...
      obj.count = $("#registration_nested_form").children(".fields").length+1  
      $('form').on 'click', '.add_fields', (event) ->
