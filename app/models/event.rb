class Event < ActiveRecord::Base
  attr_accessible :bibles_distributed, :date, :end_time, :gospel_shared, :meals_served, :program_id, :start_time
  ...
  validates_numericality_of :meals_server, :only_integer => true, :greater_than_or_equal_to => 0
